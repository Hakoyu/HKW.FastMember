...
sealed class HyperTypeDescriptor : CustomTypeDescriptor
{
    ...
    static readonly Dictionary<PropertyInfo, PropertyDescriptor> properties =
    ...
    )
    {
        ...
        Type wrapMe = Assembly
            .GetAssembly(typeof(PropertyDescriptor))
    ...
    private static bool TryCreatePropertyDescriptor(ref PropertyDescriptor descriptor)
    {
        try
        {
            ...
            lock (properties)
            {
                ...
                baseMethod = typeof(ChainingPropertyDescriptor)
                    .GetProperty("SupportsChangeEvents")
                    .GetGetMethod();
                mb = tb.DefineMethod(
                    baseMethod.Name,
                    MethodAttributes.HideBySig
                ...
                */
                ...
                if (!property.DeclaringType.IsValueType)
                {
                    ...
                    if (supportsChangeEvents)
                    {
                        ...
                        if (ei != null)
                        {
                            baseMethod = typeof(ChainingPropertyDescriptor).GetMethod(
                                "AddValueChanged"
                            );
                            mb = tb.DefineMethod(
                                baseMethod.Name,

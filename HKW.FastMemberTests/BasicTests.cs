...
public class BasicTests
{
    ...
    public interface IPropseOnInheritedComposedInterface
        : IPropsOnInheritedInterface,
            IPropsOnInterfaceBase2
    {
        int M { get; set; }
        string N { get; set; }
        DateTime? O { get; set; }
    ...
    public class HasNoDefaultCtor
    {
        public HasNoDefaultCtor(string s) { }
    }
    ...
    public void TestCtor()
    {
        ...
        Assert.IsInstanceOfType<HasDefaultCtor>(obj);
    }
    ...
    public class HasGetterPrivateSetter
    {
        ...
        public HasGetterPrivateSetter(int value)
        {
            Foo = value;
        }
    }
    ...
    public void TestReaderAllColumnsWithPartiallyDefinedOrder()
    {
        var source = new[]
        {
            new ObjectReaderWithPartiallyDefinedColumnsOrderType
            {
                A = 123,
                B = "abc",
                C = 1,
    ...
    public void TestReaderAllColumnsWithDefinedOrder()
    {
        var source = new[]
        {
            new ObjectReaderWithDefinedColumnsOrderType
            {
                A = 123,
                B = "abc",
                C = 1,
    ...
    public void TestGetMembersOnInheritedInterface()
    {
        ...
        Assert.IsTrue(access.GetMembersSupported);
        var members = access.GetMembers();
        Assert.AreEqual(8, members.Length);
        Assert.AreEqual("A", members[0].Name);
        Assert.AreEqual("B", members[1].Name);
        Assert.AreEqual("C", members[2].Name);
        Assert.AreEqual("D", members[3].Name);
    ...
    public void TestGetMembersOnComposedInterface()
    {
        ...
        Assert.IsTrue(access.GetMembersSupported);
        var members = access.GetMembers();
        Assert.AreEqual(12, members.Length);
        Assert.AreEqual("A", members[0].Name);
        Assert.AreEqual("B", members[1].Name);
        Assert.AreEqual("C", members[2].Name);
        Assert.AreEqual("D", members[3].Name);
    ...
    public void TestGetMembersOnInheritedComposedInterface()
    {
        ...
        Assert.IsTrue(access.GetMembersSupported);
        var members = access.GetMembers();
        Assert.AreEqual(16, members.Length);
        Assert.AreEqual("A", members[0].Name);
        Assert.AreEqual("B", members[1].Name);
        Assert.AreEqual("C", members[2].Name);
        Assert.AreEqual("D", members[3].Name);
